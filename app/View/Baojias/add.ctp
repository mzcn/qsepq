        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="baojia_form" name="baojia_form" method="post" action="/baojias/add" role="form">
                                <div class="form-group">
                                    <label for="baojia_id">总项目编号</label>
                                    <input id="baojia_id" name="baojia_id" maxlength="20" class="form-control" readonly
                                           value="<?php echo $bianhao; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="name">总项目名称</label>
                                    <input id="name" name="name" maxlength="100" class="form-control">
                                    <span style="margin-left:5px; color: red; ">*</span><span id="name_error"></span>
                                </div>
                                <div class="form-group">
                                    <label for="customer">客户名称</label>
                                    <input id="customer" name="customer" maxlength="100" class="form-control">
                                    <span style="margin-left:5px; color: red; ">*</span><span
                                        id="customer_error"></span>
                                </div>
                                <div class="form-group">
                                    <label for="description">总项目描述</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input id="cost_price"
                                                                               name="cost_price"
                                                                               value="<?php isset($first_detail['cost_price']) ? $first_detail['cost_price']:'' ?>"
                                                                               class="form-control"
                                                                               type="hidden">
                                                                    </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label>差旅费</label>
                                            <input id="tour_cost" name="tour_cost" class="form-control"
                                                   placeholder="10%"
                                                   onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46"
                                                   onpaste="return !clipboardData.getData('text').match(/\D/)"
                                                   ondragenter="return false"
                                        ...
                                        <div class="form-group col-md-3">
                                            <label>安装调试费用</label>
                                            <input id="setup_cost" name="setup_cost" class="form-control"
                                                   placeholder="10%"
                                                   onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46"
                                                   onpaste="return !clipboardData.getData('text').match(/\D/)"
                                                   ondragenter="return false"
                                        ...
                                        <div class="form-group text-center">
                                            <button id="btn_save" name="btn_save" type="submit" class="btn btn-default">
                                                保存
                                            </button>
